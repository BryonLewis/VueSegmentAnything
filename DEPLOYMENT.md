...
Be sure to use the proper hostname (djangosam.kitware.com) in
...
3. Run  `docker compose run --rm django ./manage.py makeclient \
                            ...
                            --uri https://djangosam.kitware.com/`
...
9. After creating the basic application log into the django admin `djangosam.kitware.com/admin`
...
Make sure that there is the grts.csv in the /opt/djangosam/dev/grtsCells folder
...
TimeoutStartSec=300
RestartSec=20
WorkingDirectory=/opt/djangosam
...
After run `sudo systemctl enable djangosam.service`
Then to start you can use `sudo systemctl start djangosam.service`
Stopping: `sudo systemctl stop djangosam.service`
