...
class DjangoSAMMixin(ConfigMixin):
    WSGI_APPLICATION = 'djangosam.wsgi.application'
    ROOT_URLCONF = 'djangosam.urls'
    ...
    def mutate_configuration(configuration: ComposedConfiguration) -> None:
        ...
        configuration.INSTALLED_APPS = [
            'djangosam.core.apps.CoreConfig',
        ] + configuration.INSTALLED_APPS
...
class DevelopmentConfiguration(DjangoSAMMixin, DevelopmentBaseConfiguration):
...
class TestingConfiguration(DjangoSAMMixin, TestingBaseConfiguration):
    pass


class KitwareConfiguration(DjangoSAMMixin, _BaseConfiguration):
    SECRET_KEY = values.SecretValue()
    baseHost = 'djangosam.kitware.com'
...
class ProductionConfiguration(DjangoSAMMixin, ProductionBaseConfiguration):
    pass


class HerokuProductionConfiguration(DjangoSAMMixin, HerokuProductionBaseConfiguration):
    pass
